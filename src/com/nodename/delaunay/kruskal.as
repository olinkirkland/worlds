package com.nodename.delaunay {
     ...
     */
    public function kruskal(lineSegments:Vector.<Segment>, myType:String = "minimum"):Vector.<Segment> {
        var nodes:Dictionary = new Dictionary(true);
        var mst:Vector.<Segment> = new Vector.<Segment>();
        ...
        switch (myType) {
            ...
            case "maximum":
                ...
                break;
            default:
                lineSegments.sort(Segment.compareLengths_MAX);
                break;
        }

        for (var i:int = lineSegments.length; --i > -1;) {
            var lineSegment:Segment = lineSegments[i];
