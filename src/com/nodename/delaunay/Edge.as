package com.nodename.delaunay {
    ...
    public final class Edge {
        ...
        public function delaunayLine():Segment {
            // draw a line connecting the input Sites for which the edge is a bisector:
            return new Segment(leftSite.coord, rightSite.coord);
        }

        public function voronoiEdge():Segment {
            if (!visible) return new Segment(null, null);
            return new Segment(_clippedVertices[LR.LEFT],
