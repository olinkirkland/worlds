package layers.wind
{
    ...
    public function propagate():Array
    {
        ...
        var angle1Distance:Number = Util.round(Math.abs(Util.differenceBetweenTwoDegrees(vector.angle, Util.toRadians(angle1))));
        var angle2Distance:Number = Util.round(Math.abs(Util.differenceBetweenTwoDegrees(vector.angle, Util.toRadians(angle2))));
